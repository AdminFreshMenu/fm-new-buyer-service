...
public class BitsilaControllerTest extends AbstractTestNGSpringContextTests {
  ...
  private void cleanupTestData() {
    ...
    public void testCreateBitsilaOrder_DuplicateOrder() throws Exception {
        ...
        // Then, attempt to create the same order again
        String orderRequestJson = """
                {
                  "order": {
                    "order_no": "15860-1004-3091",
    ...
    @Test(groups = {"api", "smoke"}, priority = 3,description = "Test order creation with a missing order number.")
    ...
    @Test(groups = {"api", "smoke"}, priority = 4,description = "Test order creation with no order items.")
    ...
    @Test(groups = {"api", "smoke"}, priority = 5,description = "Test order creation with invalid item quantity.")
